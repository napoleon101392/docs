...
return [
    ...
    'Supporting Structure' => [
        ...
        'Routing'          => __DIR__.'/supporting_structure/routing.md',
    ...
    'Services' => [
        'Aliases'              => __DIR__.'/services/aliases.md',
        ...
        'Filter'               => __DIR__.'/services/filter.md',
        ...
        'Log'                  => __DIR__.'/services/log.md',
        'Mail'                 => __DIR__.'/services/mail.md',
        // 'Metadata Adapter'  => __DIR__.'/services/metadata_adapter.md',
